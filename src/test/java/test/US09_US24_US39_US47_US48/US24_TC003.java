...
public class US24_TC003 extends TestBaseReport {
    ...
    public void BirinciBlogSayfasi () {
        ...
        extentTest = extentReports.createTest("Kullanici girisi sonrasi Birinci blog sayfasi ayrintilari testi",
    ...
    public void IkinciBlogSayfasi (){
        extentTest = extentReports.createTest("Kullanici girisi sonrasi Ikinci blog sayfasi ayrintilari testi","Ikinci blog sayfasinin ayrintilari gorunur olmali");
        Driver.getDriver().get(ConfigReader.getProperty("url"));
        extentTest.info("Kullanici anasayfaya gider");
        AccountPage_Property kullanici = new AccountPage_Property();
        kullanici.signIn.click();
    ...
    public void UcuncuBlogSayfasi () {
        extentTest = extentReports.createTest("Kullanici girisi sonrasi Ucuncu blog sayfasi ayrintilari testi", "Ucuncu blog sayfasinin ayrintilari gorunur olmali");
        Driver.getDriver().get(ConfigReader.getProperty("url"));
        extentTest.info("Kullanici anasayfaya gider");
        AccountPage_Property kullanici = new AccountPage_Property();
        kullanici.signIn.click();
    ...
    public void DorduncuBlogSayfasi () {
        extentTest = extentReports.createTest("Kullanici girisi sonrasi Dorduncu blog sayfasi ayrintilari testi", "Dorduncu blog sayfasinin ayrintilari gorunur olmali");
        Driver.getDriver().get(ConfigReader.getProperty("url"));
        extentTest.info("Kullanici anasayfaya gider");
        AccountPage_Property kullanici = new AccountPage_Property();
        kullanici.signIn.click();
    ...
    public void BesinciBlogSayfasi () {
        extentTest = extentReports.createTest("Kullanici girisi sonrasi Besinci blog sayfasi ayrintilari testi", "Besinci blog sayfasinin ayrintilari gorunur olmali");
        Driver.getDriver().get(ConfigReader.getProperty("url"));
        extentTest.info("Kullanici anasayfaya gider");
        AccountPage_Property kullanici = new AccountPage_Property();
        kullanici.signIn.click();
    ...
    public void AltinciBlogSayfasi () {
        extentTest = extentReports.createTest("Kullanici girisi sonrasi Altinci blog sayfasi ayrintilari testi", "Altinci blog sayfasinin ayrintilari gorunur olmali");
        Driver.getDriver().get(ConfigReader.getProperty("url"));
        extentTest.info("Kullanici anasayfaya gider");
        AccountPage_Property kullanici = new AccountPage_Property();
        kullanici.signIn.click();
    ...
    public void YedinciBlogSayfasi () {
        extentTest = extentReports.createTest("Kullanici girisi sonrasi Yedinci blog sayfasi ayrintilari testi", "Yedinci blog sayfasinin ayrintilari gorunur olmali");
        Driver.getDriver().get(ConfigReader.getProperty("url"));
        extentTest.info("Kullanici anasayfaya gider");
        AccountPage_Property kullanici = new AccountPage_Property();
        kullanici.signIn.click();
    ...
    public void SekizinciBlogSayfasi () {
        extentTest = extentReports.createTest("Kullanici girisi sonrasi Sekizinci blog sayfasi ayrintilari testi", "Sekizinci blog sayfasinin ayrintilari gorunur olmali");
        Driver.getDriver().get(ConfigReader.getProperty("url"));
        extentTest.info("Kullanici anasayfaya gider");
        AccountPage_Property kullanici = new AccountPage_Property();
        kullanici.signIn.click();
    ...
    public void DokuzuncuBlogSayfasi () {
        extentTest = extentReports.createTest("Kullanici girisi sonrasi Dokuzuncu blog sayfasi ayrintilari testi", "Dokuzuncu blog sayfasinin ayrintilari gorunur olmali");
        Driver.getDriver().get(ConfigReader.getProperty("url"));
        extentTest.info("Kullanici anasayfaya gider");
        AccountPage_Property kullanici = new AccountPage_Property();
        kullanici.signIn.click();
    ...
    public void OnuncuBlogSayfasi () {
        extentTest = extentReports.createTest("Kullanici girisi sonrasi Onuncu blog sayfasi ayrintilari testi", "Onuncu blog sayfasinin ayrintilari gorunur olmali");
        Driver.getDriver().get(ConfigReader.getProperty("url"));
        extentTest.info("Kullanici anasayfaya gider");
        AccountPage_Property kullanici = new AccountPage_Property();
        kullanici.signIn.click();
    ...
    public void OnbirinciBlogSayfasi () {
        extentTest = extentReports.createTest("Kullanici girisi sonrasi Onbirinci blog sayfasi ayrintilari testi", "Onbirinci blog sayfasinin ayrintilari gorunur olmali");
        Driver.getDriver().get(ConfigReader.getProperty("url"));
        extentTest.info("Kullanici anasayfaya gider");
        AccountPage_Property kullanici = new AccountPage_Property();
        kullanici.signIn.click();
    ...
    public void OnikinciBlogSayfasi () {
        extentTest = extentReports.createTest("Kullanici girisi sonrasi Onikinci blog sayfasi ayrintilari testi", "Onikinci blog sayfasinin ayrintilari gorunur olmali");
        Driver.getDriver().get(ConfigReader.getProperty("url"));
        extentTest.info("Kullanici anasayfaya gider");
        AccountPage_Property kullanici = new AccountPage_Property();
        kullanici.signIn.click();
